...
\title{Verteilte Hasttable unter MPI}
\date{25.01.2018}
...
\section{Aktivitäten durch Threads}
\begin{frame}[fragile]
\begin{center}
...
\node [below right, align=left] at (-0.5,-6.5) {\emph{Hashtable-Aktivitäten}\\
Abarbeitung von:\\
-- Insert\\
-- Get\\
-- Delete};
...
\draw [latex-latex, shorten >=5, shorten <=5] (7,-4) -- (13,-4) -- (13,-1);
%\draw [-latex, shorten >=5, dashed] (9,-3) -- (12,-3) -- (12,-5);
\draw [-latex, shorten >=5] (10,-4) -- (10,-9) -- (13,-9) -- (13,-8);
\end{tikzpicture}
}
\end{center}
\end{frame}
...
Zuordnung Prozess: \hspace*{1.35cm}$p=x\mod n$

Zuordnung Tabelleneintrag: \hspace*{.2cm}$t=(x/n)\mod m$
